...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/AayushXmusic/AliceXMusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/UH_KNOW_AYU")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Nancy_Support")
